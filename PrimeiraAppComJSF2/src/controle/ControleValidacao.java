...
public class ControleValidacao implements Serializable {
	...
	@Pattern(regexp="\\(\\d{2}\\)\\d{4}\\-\\d{4}", message="O formato telefone de ser (99)9999-9999")
	private String telefone;
	@Email(message="indforme um email válido")
	@NotEmpty(message="O email deve ser informado")
	private String email;
	@NotNull(message="A idade deve ser informada")
	@Range(min=12, max=80, message="A idade eve estar entre {min} e {max} anos" )
	private Long idade;
